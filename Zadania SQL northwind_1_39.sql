...
*/
/* -- Zadanie 8 Wyświetl wszystkie informacje o produktach, które mają określona minimalną liczbę zamówienia  
SELECT 
    *
FROM
    products
...
WHERE
 ...
 -- ew. AND city <> 'Redmond' */
/* -- Zadanie 12 Wyświetl informacje o klientach, którzy nie są menadżerami. 
SELECT 
    *
FROM
    customers
...
*/
/* -- Zadanie 20 Zaprezentuj raport dla dyrekcji, który będzie zawierał następujące kolumny: Imie_Pracownika,
Nazwisko_Pracownika, Miasto. Na raporcie umieść tylko pracowników z Seattle 
SELECT 
...
WHERE
    shipping_fee > 0;
*/
/* -- Zadanie 28. Ile łącznie zamówiono produktu Northwind Traders Cofee (id=43). 
SELECT 
    SUM(quantity)
FROM
    order_details
...
-- kolumny wyświetlają się w kolejności z zapytania!
*/
...
*/
 /* -- Zadanie 35 Zweryfkikuj czy wszyscy klienci złożyli już zamówienie. Wyswietl nazwy wszystkich klientów wraz z datą zamówienia i datą dostawy zamówienia 
SELECT 
...
*/
/* -- Zadanie 37 Dyrekcja prosi o przygotowanie raportu, który wykaże, czy wszyscy pracownicy składali zamówienia. Raport powienien zawierać datę zamówienia, nazwisko pracowanik i jego stanowisko pracy. Ilu pracowników nie złożyło zamówienia?
SELECT 
...
/* -- Zadanie 38 Przygotuj zestawienie, które będzie zawierało dane: nazwa klienta, data zawmówieniam i data dostawy 
SELECT 
